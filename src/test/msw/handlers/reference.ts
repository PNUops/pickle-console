...
export const ubuntuTemplate: Schemas['OsImageResponse'] = {
  id: 1,
  name: 'ubuntu-24.04',
...
export const templates: Schemas['OsImageResponse'][] = [ubuntuTemplate]
...
export const referenceHandlers: RequestHandler[] = [
  ...
  http.get('*/api/v1/os-images', () => HttpResponse.json(templates, { status: 200 })),
