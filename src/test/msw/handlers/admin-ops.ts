...
function initialDriftFindings(): DriftFindingView[] {
  return [
    ...
    },
    {
      ...
      proxmoxVmid: 100901,
      nodeName: 'pve1',
      summary: 'Proxmox에 플랫폼이 모르는 게스트(vmid 100901)가 있습니다.',
      detail: null,
      status: 'OPEN',
    ...
    },
    {
      ...
      proxmoxVmid: 100900,
      nodeName: 'pve1',
      summary: 'Proxmox에 플랫폼이 모르는 게스트(vmid 100900)가 있습니다.',
      detail: null,
      status: 'RESOLVED',
    ...
    nodesLive: [
      {
        ...
        memUsedBytes: 24_576 * 1024 * 1024,
        storageTotalBytes: 900 * 1024 * 1024 * 1024,
        storageUsedBytes: 320 * 1024 * 1024 * 1024,
