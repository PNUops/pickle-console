 ...
 *
 * 정본은 게이트웨이 설정이고 여기 있는 값은 화면 표시용 사본이다. 콘솔은 게이트웨이
 * 설정을 읽는 경로가 없어서 사본을 둘 수밖에 없는데, 사용 가이드와 키 상세 화면이
 * 각자 문자열을 들고 있으면 한쪽만 고쳐진 채 남으므로 한 곳에 모은다.
 */
