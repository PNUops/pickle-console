        ...
        body: (
          <>
            <p>
              ...
              직접 레코드를 넣어 외부 서버나 호스팅 서비스에 연결합니다. 별도 신청 승인 없이
              발급되며, 이름은 선택한 워크스페이스에 속합니다.
            </p>
            <p>
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>
              사용 중이거나 예약된 이름은 발급할 수 없습니다. 워크스페이스별 개수 제한에는
              해제 후 예약 중인 이름도 포함됩니다. 함께 관리할 구성원에게는 상세 화면의
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>
              예약 기간에는 같은 워크스페이스에서 같은 이름을 발급받아 되찾을 수 있습니다.
