    ...
    sections: [
      {
        ...
        body: (
          <>
            <p>
              가입 후 처음 콘솔에 들어오면 직책과 학번, 소속을 입력하는 화면이 먼저 열립니다.
              입력을 마쳐야 콘솔을 이용할 수 있습니다. 입력한 프로필은 상단 계정 메뉴의{' '}
              <GuideAction action="account">계정 설정</GuideAction>에서 확인하고, 이름은 그곳에서
              변경합니다.
            </p>
            <p>
            ...
            <p>
              학번은 한 계정에만 등록됩니다. 이미 다른 계정에 등록된 학번이라는 안내가 나오면 학번을
              다시 확인하고, 맞다면 문의 창구로 알려 주세요.
            </p>
          </>
        ),
      },
