...
const scenes = [
  ...
  ['workspaces/manage', 'members', 'workspace-members', 1104, 213],
  ['workspaces/access', 'grant', 'resource-access', 1104, 479],
  ['vm/request', 'configure', 'vm-request', 768, 874],
  ...
  ['llm/start', 'choose-models', 'llm-request', 768, 802],
